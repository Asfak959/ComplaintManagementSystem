...
//   show login user Complaints on index page
    @GetMapping("/loginUserComplaints")
    public List <Complaint> loginUserComplaint (Authentication authentication){
        String email = authentication.getName();
        return complaintService.getLoginUserComplaints(email);
    }
